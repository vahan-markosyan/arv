...
export class DoctorControllers {
    async getList(resource, params) {
        ...
        const response = await fetch(`${API_URL}/doctor/${resource}`);
    ...
    async delete(resource, params) {
        const { id } = params;
        const response = await fetch(`${API_URL}/doctor/${resource}/${id}`, {
            method: 'DELETE',
            headers: {
    ...
    async update(resource, params) {
        ...
        try {
            const response = await fetch(`${API_URL}/doctor/${resource}/${params.id}`, {
                method: 'PUT',
                body: formData,
            });
    ...
    async deleteMany(resource, params) {
        ...
        const promises = ids.map((id) => 
            fetch(`${API_URL}/doctor/${resource}/${id}`, {
                method: 'DELETE',
            })
        );
